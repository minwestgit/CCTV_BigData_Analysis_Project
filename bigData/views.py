...
class GetFromToDate:
    def __init__(self, FromDate, ToDate, RadioValue, FromDate2, ToDate2, RadioValue2):
...
def PersonRule(request):
    GetPerson = models.Mongo()
    dataPerson = GetPerson.Find_Person_Mongo()
    result = []
    result = main(dataPerson)
    return HttpResponse(result, content_type="application/json")
